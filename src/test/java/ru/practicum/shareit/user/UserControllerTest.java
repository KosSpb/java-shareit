...
class UserControllerTest {
    ...
    @Test
    @SneakyThrows
    void createUser_whenRequestDtoIsNotValidCauseOfErrorInEmail_thenResponseStatusBadRequest() {
        UserDto userRequestDto = new UserDto(null, "Pete", "akela_stottsj@s");
    ...
    @Test
    @SneakyThrows
    void updateUser_whenRequestDtoIsNotValidCauseOfEmptyName_thenResponseStatusBadRequest() {
        Long userId = 1L;
        UserDto userRequestDto = new UserDto(null, "", null);
