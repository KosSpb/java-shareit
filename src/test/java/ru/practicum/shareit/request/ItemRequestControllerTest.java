...
class ItemRequestControllerTest {
    ...
    @Test
    @SneakyThrows
    void createItemRequest_whenRequestDtoIsNotValidCauseOfEmptyDescription_thenResponseStatusBadRequest() {
        ItemRequestDtoOfRequest itemRequestDtoOfRequest = new ItemRequestDtoOfRequest("");
        ...
        verify(itemRequestService, never()).createItemRequest(any(), anyLong());
    }
