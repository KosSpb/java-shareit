...
class ItemControllerTest {
    ...
    @Test
    @SneakyThrows
    void createItem_whenRequestDtoIsNotValidCauseOfEmptyDescription_thenResponseStatusBadRequest() {
        ItemRequestDto itemRequestDto =
                new ItemRequestDto(null, "ball", "", true, null);
    ...
    @Test
    @SneakyThrows
    void updateItem_whenRequestDtoIsNotValidCauseOfTooLongName_thenResponseStatusBadRequest() {
        Long itemId = 1L;
    ...
    @Test
    @SneakyThrows
    void createComment_whenRequestDtoIsNotValidCauseOfEmptyText_thenResponseStatusBadRequest() {
        Long itemId = 1L;
        CommentDto commentRequestDto =
                new CommentDto(null, "", "Mark", LocalDateTime.now().plusDays(2));
        ...
        verify(itemService, never()).createComment(any(), anyLong(), anyLong());
    }
}